      ...
      <div className="bg-white border-[6px] border-black p-10 md:p-14 max-w-md w-full shadow-[24px_24px_0px_rgba(0,0,0,1)]">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-black text-white font-black uppercase tracking-[0.3em] border-4 border-black shadow-[8px_8px_0px_#EC6C00] active:translate-y-1 active:shadow-none transition-all"
          >
            {loading ? '処理中…' : title}
          </button>
        </form>
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button
            ...
            className="text-[11px] font-black underline text-slate-500"
            disabled={!email}
            title="メールアドレスを入力してから押してください"
          >
            パスワード再発行
